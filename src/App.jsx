...
const App = () => {
  ...
  return (
    ...
    <Projects/>
      ...
      <form className='w-full col-span-12  sm:mt-10 lg:mt-0 md:col-span-6'>
        <div className='flex-col flex gap-y-1 text-sm'>
          <label>Name</label>
        <input type='text' placeholder='Enter Your Name' className=' w-full py-2.5 bg-[#374151] rounded-lg px-3 border-none outline-none'/>
        </div>
        <div className='flex-col flex gap-y-1 mt-4 text-sm'>
          <label>Email</label>
        <input type='email' placeholder='Enter Your Email' className='  py-2.5 w-full bg-[#374151] rounded-lg px-3 border-none outline-none'/>
        </div>
        <div className='flex-col flex gap-y-1 mt-4 text-sm'>
          <label >Message</label>
        <textarea rows={7} placeholder='Enter Your Message' className='py-2 w-full bg-[#374151] rounded-lg px-3 border-none outline-none'/>
        </div>
        <button className='bg-[#1788ae]  w-full font-medium py-2 rounded-lg mt-4'>Connect</button>
    </form>
      </div>
